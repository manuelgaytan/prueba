...
@PageObject
public class AltaPersonaMoralUI extends AbstractPage {
    ...
    @FindBy (xpath = "//input[@mp-name='thpAcvWthpDcmVal']")
    ...
    @FindBy (xpath = "//label[text()='Tipología:']/..//input[@id='tylVal']")
    public WebElement getInputDataBasicTipologia;
    @FindBy (xpath = "//label[text()='Categoría de Proveedor:']/..//input[@id='splCtgVal']")
    ...
    public WebElement clicCheckFisicoJuridico;

//    @FindBy (xpath = "")
//    public WebElement ;

    public AltaPersonaMoralUI(DriverManager driverManager){
        super(driverManager);
    }
}
