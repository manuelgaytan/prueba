@CSV
@Regresion-REC @CIMSSiniestro-REC
Feature: Flujos Siniestros

  @SiniestroColision-REC @RegresionCIMS-REC
...
| 4102500044074 | 1 | 5 | DAOS A TERCERO BIENES Y PERS | MEX | 21 | 21197 | 73080 | Hidalgo | Centro | Privada de Juarez Y Guerrero | N | MEX | CAL | Calle Hidalgo #200 Col. Centro | 21197 | Testing | Centro | Privada de Juarez Y Guerrero | Ninguna referencia | 73080 | 1 | N | 1 | null | null | 20.250462910699095 | -97.9463570164121 | ERNESTO	 | MORALES | NEVAREZ | COLISION Y/O VOLCADURA |
  ...
  @CreacionExpediente-REC @RegresionCIMS-REC
  ...
  @TerminacionExpediente-REC @RegresionCIMS-REC
  ...
  @RehabilitacionExpediente-REC @RegresionCIMS-REC
  ...
  @rehabilitacionSiniestro-REC @RegresionCIMS-REC
  ...
  @modificacionExpediente-REC @RegresionCIMS-REC
  ...
  @modificacionSiniestro-REC @RegresionCIMS-REC
  ...
  @noAbrirExpediente-REC @RegresionCIMS-REC
