...
@Task
public class AutomovilesFlotillasTask {
    ...
    public void primerPantalla7() {
        ...
        Util.explicitWait(4);
        Util.tab(manager.getDriver());
        this.flotillasEmisionUI.inputCodProduct.sendKeys("2");
        Util.pageStatus(manager.getDriver());
        Util.explicitWait(2);
        Util.tab(manager.getDriver());
        Util.explicitWait(2);
    ...
    @ShotAfter(evidenceName = "Cotización de autos flotillas")
    public void segundaPantalla(String codAmbCirculacion, String codTipoVehi, String tipoIndemnizacion, String codMarca, String codModelo, String codSubModelo, String anioSubModelo, String codUsoVehiculo, String codModalidad) {
        ...
        this.flotillasEmisionUI.btnSiguienteGlobal.click(); //ERROR AQUI
        Util.explicitWait(2);
        ...
        Util.explicitWait(2);
        Util.pageStatus(manager.getDriver());
        Util.scrollToElement2(manager.getDriver(), flotillasEmisionUI.btnAceptarAtributos);
...
//        }
        ...
        Util.pageStatus(manager.getDriver());
        Util.explicitWait(2);
        this.flotillasEmisionUI.selectRcTerceros.click();
        Util.pageStatus(manager.getDriver());
        Util.explicitWait(2);
        String varCot = this.flotillasEmisionUI.cantidadCot.getAttribute("value");
        this.flotillasEmisionUI.selectRcTerceros.click();
        ...
        Util.pageStatus(manager.getDriver());
        Util.explicitWait(2);
        String varCot2 = this.flotillasEmisionUI.cantidadCot.getAttribute("value");
    ...
    public void datosModificar2() {
        ...
        // Neto
        Util.explicitWait(1);
        if(Util.webElementIsEnabled(10,manager.getDriver(),this.flotillasEmisionUI.btnObservacionContinuarEmision)){
            Util.explicitWait(1);
            this.flotillasEmisionUI.btnObservacionContinuarEmision.click();
    ...
    public void emisionFlotillas() {
        ...
        String noPoliza2 = noPoliza1.replace("-0-0-0]","");
        ExcelData.writeJson("PolizaFlotillas", noPoliza2);
        Util.explicitWait(2);
        Util.waitElementNoVisible(manager.getDriver(), "//div[@class='loading-container ng-isolate-scope darkness']");
        Util.pageStatus(manager.getDriver());
    }
    @ShotAfter(evidenceName = "Clic botón salir")
