...
@PageObject
public class FlotillasEmisionUI extends AbstractPage {
    ...
    @FindBy(xpath = "//*[@id='plyInePlhW_thpDcmTypVal' and @disabled='disabled']")
    public WebElement inputTipDocRFCDisabled;
    ...
    @FindBy(xpath = "//*[@id=\"VAL_DESC_REC\"]")
    public WebElement inputDescuento;
    ...
    @FindBy(xpath = "//label[@title='CP CH MAYOR RIESGO']/following::input[@name='CP_CH_RIESGO'][1]")
    public WebElement inputcpCHRiesgo;
...
//    public WebElement btnIngresar;
    ...
    @FindBy(xpath = "//fieldset[@ng-disabled=\"isDsbAccordion('obs')\"]//li[1]//a[1]//label[1]")
    ...
    public FlotillasEmisionUI(DriverManager driverManager){
        super(driverManager);
    }
}
