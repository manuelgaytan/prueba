@CSV
@InsumoMobile @CIMSAdministracion23 @SiniestrosRegressionRec
Feature: Insumos para Automatización Mobile

  @InsumoSiniestroColision
  Scenario Outline:Siniestro Colision
    #siniestro_colision_rec.csv |
...
| 4102500044074 | 2 | 5 | ROBO TOTAL | MEX | 21 | 21197 | 73080 | Hidalgo | Centro | Privada de Juarez Y Guerrero | S | MEX | CAL | Calle Benito Juarez # 560 | 21197 | Calle Benito Juarez # 560 | Centro | Privada de Juarez Y Guerrero | ninguna | 07470 | 1 | N | 3 | null | null | 19.250462910699095 | -99.9463570164121 | FERNANDO | VARGAS | ORTIZ |
