...
@PageObject
public class IndividualSiniestroUI extends AbstractPage {
    ...
    @FindBy(xpath = "//span[text()='Apertura siniestro']")
...
//    public WebElement btnIngresar;
    ...
    @Autowired
    public IndividualSiniestroUI(DriverManager driverManager) {
        super(driverManager);
    }
