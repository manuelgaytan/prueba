@CSV
Feature: Flujos Siniestros Robo (RTA,DJA,LEO)

  @siniestrosRobo-REC
  Scenario Outline:Siniestro Robo
    ...
    And Busqueda de apertura de siniestro nuevo "<codigoMotivoSiniestro>","<codTipoAsegurado>","<consecuencia>","<consecuencia2>","<consecuencia3>"
...
#4102500003358 | 4102500044074
    Examples:
      | poliza | codigoMotivoSiniestro | codTipoAsegurado | consecuencia | consecuencia2 | consecuencia3 | codPais | codEstado | codPoblacion | codPostal | calle | colonia | entreCalles | mismoLugarRobo | codPaisRT | ubiVia | direccionA | codPoblacionRT | calleyNoRT | coloniaRT | entreCallesRT | referenciaRT | cpRT | color | cita | tipoAjuste | codAbogado | codAjustador | latitud | longitud | nombre | apellidoPat | apellidoMat | motivoSiniestro |
      | 4102500044074 | 2 | 5 | ROBO TOTAL | LESIONADOS VEHICULO ASEGURADO | DEFENSA JURIDICA | MEX | 21 | 21197 | 73080 | Hidalgo | Centro | Privada de Juarez Y Guerrero | N | MEX | CAL | Calle Hidalgo #200 Col. Centro | 21197 | Testing | Centro | Privada de Juarez Y Guerrero | Ninguna referencia | 73080 | 1 | N | 1 | null | null | 20.250462910699095 | -97.9463570164121 | ERNESTO | MORALES | NEVAREZ | COLISION Y/O VOLCADURA |


  @CreacionExpedienteRobo-RE
  Scenario: CP002_Creacion de expendiente RTA
